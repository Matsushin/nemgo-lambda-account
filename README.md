...
This is a sample template for lambda-nem - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name lambda-nem --query 'Stacks[].Outputs'
```
